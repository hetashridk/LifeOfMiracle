...
export function Testimonials() {
  return (
    <section style={{ padding: '7rem 0', background: '#0e3f52', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ ...W, position: 'relative', zIndex: 1 }}>
        <motion.p
          ...
          style={{ fontSize: '0.6rem', fontWeight: 900, letterSpacing: '5px', textTransform: 'uppercase', color: 'rgba(242,117,82,0.8)', marginBottom: '1rem', textAlign: 'center' }}
        >
          What People Say
        </motion.p>
        ...
        <motion.h2
          ...
          style={{ fontSize: 'clamp(1.6rem, 3vw, 2.8rem)', fontWeight: 900, color: '#fff', textAlign: 'center', lineHeight: 1.1, letterSpacing: '-0.03em', marginBottom: '4rem' }}
        >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(280px,1fr))', gap: '2rem' }}>
          {TESTIMONIALS.map((t, i) => (
            ...
            >
              ...
              <p style={{ fontSize: '1rem', color: 'rgba(255,255,255,0.78)', lineHeight: 1.85, marginBottom: '2rem', fontStyle: 'italic' }}>
                {t.quote}
              </p>
