  ...
  if (submitted) {
    return (
      ...
      >
        ...
        <h3 style={{ fontSize: '1.8rem', fontWeight: 900, color: '#165b74', marginBottom: '0.75rem' }}>Application Sent</h3>
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '1.75rem' }}>
        <label style={labelStyle}>What's going on for you?</label>
        <textarea
          name="message"
          rows={6}
          placeholder="Describe what's bringing you here. What are you struggling with? What do you want to change? Be honest."
          required
