        ...
        <div style={{ ...W, position: 'relative', zIndex: 1, paddingTop: '7rem', paddingBottom: '7rem' }} className="hero-section-inner">
          <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1fr)', gap: '5rem', alignItems: 'start', alignContent: 'start' }}>
            ...
            <div>
              ...
              >
                Words That <span style={{ color: '#ea7554' }}>Stay With People</span>
              </motion.h1>
              ...
              <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }}>
                <p style={{ fontSize: '1rem', fontWeight: 700, color: '#1a1a1a', lineHeight: 1.5, marginBottom: '0.6rem' }}>
              ...
              >
                {[
                  { text: 'Available for corporate events, university convocations, panel discussions, and institutional talks',  color: '#1a1a1a', weight: 500 },
                  { text: 'Each session is tailored to your audience and theme',                                                   color: '#1a1a1a', weight: 500 },
                  { text: 'No generic motivational talk. No surface-level inspiration.',                                           color: '#1a1a1a', weight: 700 },
                ].map((line, i) => (
