    ...
    <main style={{ backgroundColor: 'transparent', minHeight: '100vh', color: '#1a1a1a', overflowX: 'hidden' }}>
      ...
      >
        <motion.div style={{ y: heroY, position: 'absolute', inset: 0, pointerEvents: 'none' }}>
          <div style={{ position: 'absolute', top: '-8rem', right: '-6rem', width: 520, height: 520, borderRadius: '50%', background: 'rgba(234,117,84,0.05)', filter: 'blur(90px)' }} />
          <div style={{ position: 'absolute', bottom: '-4rem', left: '-4rem', width: 420, height: 420, borderRadius: '50%', background: 'rgba(0,0,0,0.04)', filter: 'blur(90px)' }} />
        </motion.div>
          ...
          <div className="hero-grid" style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) minmax(0, 1fr)', gap: '5rem', alignItems: 'start' }}>
            ...
            <div>
              ...
              <motion.h1
                ...
                style={{ fontSize: 'clamp(1.2rem, 2vw, 2.2rem)', fontWeight: 900, lineHeight: 1.05, letterSpacing: '-0.04em', color: '#1a1a1a', marginBottom: '1.5rem' }}
              >
                Apply for <span style={{ color: '#ea7554' }}>1:1 Coaching</span>
              </motion.h1>
              ...
              <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }}>
                <p style={{ fontSize: '1.12rem', fontWeight: 700, color: '#1a1a1a', lineHeight: 1.5, marginBottom: '0.6rem' }}>
                  You're Not Stuck. You're Patterned.
                </p>
                <p style={{ fontSize: '1rem', color: '#1a1a1a', lineHeight: 1.85, marginBottom: '1.75rem' }}>
              ...
              <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.72 }}
                ...
                <p style={{ fontSize: '1.05rem', fontWeight: 700, color: '#1a1a1a', lineHeight: 1.6, marginBottom: '0.4rem' }}>
                  You know what to do… but you don't do it.
                </p>
                <p style={{ fontSize: '0.98rem', color: '#1a1a1a', lineHeight: 1.8, margin: 0, fontWeight: 500 }}>
              ...
              <motion.div
                ...
                style={{ display: 'flex', flexDirection: 'column', gap: '0.55rem', marginBottom: '2rem', paddingLeft: '1.25rem', borderLeft: '2px solid rgba(0,0,0,0.15)' }}
              >
                {[
                  { text: 'Most people try to fix this by changing situations, people, or routines',                                                                                                       color: '#1a1a1a', weight: 500 },
                  { text: 'Real change happens when you understand how your thoughts, emotions, and behaviors are wired',                                                                                    color: '#1a1a1a', weight: 500 },
                  { text: "That's mental fitness",                                                                                                                                                           color: '#1a1a1a', weight: 700, size: '1.08rem' },
                  { text: 'When you train your mind, you gain clarity, emotional control, stronger relationships, and the ability to move forward without being pulled back by old patterns',                 color: '#1a1a1a', weight: 500 },
                ].map((line, i) => (
              ...
              <motion.div
                ...
                style={{ display: 'flex', flexDirection: 'column', gap: '0.55rem', paddingLeft: '1.25rem', borderLeft: '2px solid rgba(0,0,0,0.1)' }}
              >
                {[
                  { text: 'This is deep, structured 1:1 work focused on your personal growth, your relationships, your career direction, and breaking patterns that hold you back', color: '#1a1a1a', weight: 500 },
                  { text: 'No generic advice. No surface-level fixes.',                                                                                                              color: '#1a1a1a', weight: 700 },
                ].map((line, i) => (
            ...
            >
              ...
              {/* <p style={{ fontSize: '0.6rem', fontWeight: 900, letterSpacing: '5px', textTransform: 'uppercase', color: '#ea7554', marginBottom: '1.25rem' }}>
                Apply Below
              </p>
              <p style={{ fontSize: '0.88rem', color: '#5a4040', lineHeight: 1.7, marginBottom: '1.75rem', fontWeight: 500 }}>
